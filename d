...
object { Stakan(color Yellow)scale 0.45 rotate <90,0,0> translate <11.5, 17.5, 0> }
 object { Stakan(color Violet)scale 0.45 rotate <90,0,0> translate <11.5, 13.5, 0> }


#declare stakyshki=union{ 
cylinder { <0, 0, 0>,                //Íèæíèé áëèæíèé ëåâûé óãîë 
          < 0, 3, 0>
          1.2               //Äàëüíèé âåðõíèé ïðàâûé óãîë
          texture { Aluminum          
...
object{
  stakyshki  
    rotate <90, 0, 0>   
    translate <11.5, 13.5, 1.7>
} 

object{
  stakyshki  
    rotate <90, 0, 0>   
    translate <11.5, 17.5, 1.7>
} 
...
box {  <0, 9, 8>,                //Íèæíèé áëèæíèé ëåâûé óãîë 
      <5, 8, 9>              //Äàëüíèé âåðõíèé ïðàâûé óãîë
      texture {                  
         pigment { color Grey } //color White -çàêðàñèòü â áåëûé öâåò 
      }                          
   }                               
...
#declare pergarodka=union{
 box { <0, 1.1, 8>,                //Íèæíèé áëèæíèé ëåâûé óãîë 
      < 10, 1, 9>               //Äàëüíèé âåðõíèé ïðàâûé óãîë
      texture {                  
         pigment { color White } //color White -çàêðàñèòü â áåëûé öâåò 
      }                          
   }                               
